(function ($) {
    ...
    $.fn.colorPalettePicker.defaults = {
        button: '<i class="fa fa-square" aria-hidden="true" id="color-picker-box-"></i>', //<button name="colorpalettebutton" class="{buttonClass}" data-toggle="dropdown"><span name="{buttonPreviewName}" style="display:none">■ </span>{buttonText}</button>
        buttonClass: 'btn btn-secondary dropdown-toggle',
        buttonPreviewName: 'colorpaletteselected',
        buttonText: '', //colorpalettediv
